                    ...
                    {msg.recommendation && (
                      <div className="pai-chat__actions">
                        <button
                          ...
                          disabled={msg.recAccepted || msg.recRejected || msg.recSaving}
                        >
                          {msg.recAccepted ? "✓ Salvato" : msg.recSaving ? "Salvataggio…" : "✓ Accetta e salva"}
                        </button>
                        <button
                          ...
                          disabled={msg.recAccepted || msg.recRejected || msg.recSaving}
                        >
                          {msg.recRejected ? "Scartata" : msg.recSaving ? "…" : "Scarta"}
                        </button>
                      </div>
                    )}
                  </div>
